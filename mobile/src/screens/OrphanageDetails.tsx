...
import { Image, View, ScrollView, Text, StyleSheet, Dimensions, ActivityIndicator, Linking, TouchableOpacity } from 'react-native';
...
const OrphanageDetails = () => {
  ...
  const routeParams = route.params as OrphanageDetailsRouteParams;
  ...
  if (!orphanage) {
    return (
      <View style={styles.loadingContainer}>
        <ActivityIndicator size={48} color="#0089a5" />
      </View>
    );
  }
